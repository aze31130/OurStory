...
public final class TalvenPhase3 implements Goal<Mob> {
	...
	public TalvenPhase3(final Boss boss, final Set<Spell> spells) {
		this.boss = boss;
		this.spells = spells;
	}
	...
	@Override
	public void start() {
		Bukkit.getServer().broadcast(Component.text("[Phase3] - Setup "));
	}

	@Override
	public void tick() {
		Bukkit.getServer().broadcast(Component.text("[Phase3] - Running "));
	}

	@Override
	public void stop() {
		Bukkit.getServer().broadcast(Component.text("[Phase3] - Stop "));
	}
